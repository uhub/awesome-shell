...
* [XIU2/Shell](https://github.com/XIU2/Shell) - 🤪 随手写的一些乱七八糟 Linux 脚本
* [6gk/fet.sh](https://github.com/6gk/fet.sh) - 🐢 a fetch written in posix shell without any external commands (sponsored by https://github.com/buffet/kiwmi)
...
* [shellhub/shell](https://github.com/shellhub/shell) - shell script hub
...
* [lework/kainstall](https://github.com/lework/kainstall) - One-click deployment of kubernetes cluster and addon components based on kubeadmin using shell scripts. 使用shell脚本基于kubeadmin一键部署kubernetes集群和addon组件。
...
* [yutakatay/dotfiles](https://github.com/yutakatay/dotfiles) - The best and strongest dotfiles. Editor: Neovim(coc.nvim); Shell: zsh(zinit, powerlevel10k); Terminal: tmux, alacritty; Desktop: i3-gaps/sway, rofi, dunst; OS: ArchLinux, (Ubuntu/Fedora/CentOS)
...
* [rb-dock8s/3proxy](https://github.com/rb-dock8s/3proxy) - Smallest and Fastest Docker container for fast proxy setup based on 3proxy SOCKS5 proxy
...
* [helderburato/dotfiles](https://github.com/helderburato/dotfiles) - ⚙️ Set up a macOS environment quickly and easily!
...
* [robotshell/magicRecon](https://github.com/robotshell/magicRecon) - This repository contain a powerful shell script to maximize the data collection process of an objective
...
* [wintrmvte/Revssl](https://github.com/wintrmvte/Revssl) - A script that automates generation of OpenSSL reverse shells
...
* [fehawen/dotfiles](https://github.com/fehawen/dotfiles) - :penguin: Linux dots
...
* [vaamonde/ubuntu-1804](https://github.com/vaamonde/ubuntu-1804) - :large_blue_circle: Curso GRÁTIS Linux Ubuntu Server
...
* [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) - A professional SSH/Telnet/Serial/Shell/Sftp client for DevOps.
