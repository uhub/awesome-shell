...
* [loyess/Shell](https://github.com/loyess/Shell) - Shadowsocks-libev with plugins one-click installation. For example: v2ray-plugin, kcptun, simple-obfs, goquiet, cloak, mos-tls-tunnel, rabbit-tcp, simple-tls...
...
* [wintrmvte/Revssl](https://github.com/wintrmvte/Revssl) - A simple script that automates generation of OpenSSL reverse shells
...
* [marlonrichert/zsh-autocomplete](https://github.com/marlonrichert/zsh-autocomplete) - IDE-style type-ahead completion for Zsh — Now asynchronous/non-blocking!
...
* [hertg/egpu-switcher](https://github.com/hertg/egpu-switcher) - 🖥🐧 Setup script for eGPUs in Linux (XServer)
...
* [SimonBaeumer/bash-tricks](https://github.com/SimonBaeumer/bash-tricks) - Simple bash tricks which make your life easier.
...
* [shellspec/shellspec](https://github.com/shellspec/shellspec) - BDD unit testing framework for bash, zsh, dash and all POSIX shell scripts with coverage reporting
...
* [Zmbackup/zmbackup](https://github.com/Zmbackup/zmbackup) - A reliable software written in Shell Script to help you in your daily task to backup and restore mails and accounts from Zimbra Open Source Email Platform.
...
* [thelinuxchoice/lizard](https://github.com/thelinuxchoice/lizard) - Extension spoofer and reverse shell generator
...
* [complexorganizations/wireguard-manager](https://github.com/complexorganizations/wireguard-manager) - Self-hosted Wireguard Manager for CentOS, Debian, Ubuntu, Arch, Fedora, Redhat, Raspbian
...
* [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) - Everyone is free
...
* [dominiksalvet/asus-fan-control](https://github.com/dominiksalvet/asus-fan-control) - :cyclone: Fan control for ASUS devices running Linux.
...
* [xwmx/nb](https://github.com/xwmx/nb) - CLI note-taking, bookmarking, and archiving with encryption, advanced search, Git-backed versioning and syncing, Pandoc-backed conversion, and more in a single portable script.
...
* [xwmx/hosts](https://github.com/xwmx/hosts) - A command line hosts file editor in a single portable script.
...
* [elithrar/dotfiles](https://github.com/elithrar/dotfiles) - dotfiles for my macOS & Linux environments ⌨️
...
* [kodhub/laravel-dockerized](https://github.com/kodhub/laravel-dockerized) - Laravel easy docker environment.
...
* [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) - A high performance SSH/Telnet/Serial/Shell/Sftp client.
...
* [bradleymackey/turbo-boost-disable](https://github.com/bradleymackey/turbo-boost-disable) - Shell wrappers and instructions for disabling Turbo Boost on macOS
...
* [fehawen/dotfiles](https://github.com/fehawen/dotfiles) - :black_circle: .dotfiles
