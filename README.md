...
* [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) - V2Ray+Websocket +TLS+Vmess/VLESS+Nginx+CDN+伪装博客+优选Cloudflare IP 一键脚本
...
* [6gk/fet.sh](https://github.com/6gk/fet.sh) - a fetch written in posix shell without any external commands
...
* [xwmx/nb](https://github.com/xwmx/nb) - CLI plain-text note-taking, bookmarking, and archiving with encryption, advanced search, Git-backed versioning and syncing, Pandoc-backed conversion, and more, in a single portable script.
