...
* [loyess/Shell](https://github.com/loyess/Shell) - Shadowsocks with plugins one-click installation. e.g. v2ray-plugin, kcptun, simple-obfs, goquiet, cloak, mos-tls-tunnel, rabbit-tcp, simple-tls, gost-plugin, xray-plugin.
...
* [Rasukarusan/shellnium](https://github.com/Rasukarusan/shellnium) - Bash selenium webdriver.
