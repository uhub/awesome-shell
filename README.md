...
* [phlinhng/v2ray-tcp-tls-web](https://github.com/phlinhng/v2ray-tcp-tls-web) - VLESS / VMess / Trojan-Go / Shadowsocks / NaïveProxy 万能脚本
...
* [complexorganizations/wireguard-manager](https://github.com/complexorganizations/wireguard-manager) - ✔️ Self-hosted Wireguard Manager for CentOS, Debian, Ubuntu, Arch, Fedora, Redhat, Raspbian
...
* [fish-plugins/fish-git-util](https://github.com/fish-plugins/fish-git-util) - Convenient git utility functions for the fish shell
...
* [fish-plugins/mono](https://github.com/fish-plugins/mono) - No bells and whistles, true minimal prompt for the fish shell
