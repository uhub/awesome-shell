...
* [pothi/backup-wordpress](https://github.com/pothi/backup-wordpress) - Shell scripts to take local and remote backups of WordPress (database and files) to S3 compatible clouds via server cron.
