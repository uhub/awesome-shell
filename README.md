...
* [adtac/climate](https://github.com/adtac/climate) - The ultimate command line tool for Linux developers! Provides a huge number of tools for developers to automate their system.
...
* [ivandavidov/minimal](https://github.com/ivandavidov/minimal) - DistroWatch: "Minimal Linux Live is a tiny Linux distribution, which is designed to be built from scratch by using a collection of automated shell scripts. Minimal Linux Live offers a core environment with just the Linux kernel, GNU C library and BusyBox userland utilities."
* [licess/lnmp](https://github.com/licess/lnmp) - Auto compile and install LNMP/LNMPA/LAMP on CentOS/RadHat/Fedora Debian/Ubuntu/Raspbian Linux. Easy install,upgrade and use.
...
* [bntzio/wipe-modules](https://github.com/bntzio/wipe-modules) - A little agent that removes the node_modules folder of non-active projects 🗑️ (bash + cron)
...
* [ismailtasdelen/Anti-DDOS](https://github.com/ismailtasdelen/Anti-DDOS) - Anti DDOS | Bash Script ✔️
...
* [tylucaskelley/setup](https://github.com/tylucaskelley/setup) - Bootstrap a macOS computer for software development
...
* [swoodford/aws](https://github.com/swoodford/aws) - A collection of Bash shell scripts for automating various tasks with AWS (Amazon Web Services) using the awscli
...
* [rgomezcasas/dotfiles](https://github.com/rgomezcasas/dotfiles) - [dot]files :penguin: - Config files for my *nix systems
...
* [scrathe/tardisIVR](https://github.com/scrathe/tardisIVR) - BASH post-processing script for Shell/SABnzbd/Radarr/Sonarr
...
* [KimDarren/git-faker](https://github.com/KimDarren/git-faker) - :ghost: You could be the best GIT-COMMITTER in the planet.
...
* [PeterDaveHello/Unitial](https://github.com/PeterDaveHello/Unitial) - 🖥  My rc / configs ／docfiles 📂 ⚙
...
* [shellscriptx/ShellBot](https://github.com/shellscriptx/ShellBot) - API em Shell Script para desenvolvimento de Bots na plataforma Telegram.
* [rji/jenkins-standalone](https://github.com/rji/jenkins-standalone) - Run a Jenkins master on Mesos and Marathon.
...
* [kopptr/shell-conf](https://github.com/kopptr/shell-conf) - A set of scripts that let you use your own shell, vim, etc configuration on any Linux machine without disturbing its configuration.
