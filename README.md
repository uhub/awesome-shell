...
* [matteocorti/check_ssl_cert](https://github.com/matteocorti/check_ssl_cert) - A shell script (that can be used as a Nagios plugin) to check an SSL/TLS connection.
...
* [clu3bot/owt](https://github.com/clu3bot/owt) - Introducing owt the most compact WiFi auditing tool that works on command line linux.
...
* [fehawen/dotfiles](https://github.com/fehawen/dotfiles) - :penguin: ~/
...
* [phyver/GameShell](https://github.com/phyver/GameShell) - "jeu" d'apprentissage du shell et des commandes standards
