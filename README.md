...
* [thoughtbot/laptop](https://github.com/thoughtbot/laptop) - A shell script which turns your OS X laptop into an awesome web development machine.
...
* [fisherman/fisherman](https://github.com/fisherman/fisherman) - Concurrent plugin manager for the fish shell http://fisherman.sh
* [drduh/pwd.sh](https://github.com/drduh/pwd.sh) - Unix shell, GPG-based password manager
* [shellfire-dev/shellfire](https://github.com/shellfire-dev/shellfire) - A repository of namespaced, composable shell (bash, sh and dash) function libraries
* [Neilpang/acme.sh](https://github.com/Neilpang/acme.sh) - An ACME Shell script: acme.sh
...
* [zsh-users/zsh-history-substring-search](https://github.com/zsh-users/zsh-history-substring-search) - ZSH port of Fish shell's history search feature.
...
* [raphaelcohn/swaddle](https://github.com/raphaelcohn/swaddle) - swaddle creates RPM, Deb and tarball packages using shell script
...
* [geerlingguy/JJG-Ansible-Windows](https://github.com/geerlingguy/JJG-Ansible-Windows) - Windows shell provisioning script to bootstrap Ansible from within a Vagrant VM.
...
* [olehkuchuk/interactive-shell](https://github.com/olehkuchuk/interactive-shell) - bash script for learning basics of UNIX terminal.
...
* [Linux-Admins/Shell](https://github.com/Linux-Admins/Shell) - Shell scripts/programs for use in Liunx Systems. (CentOS/Redhat variants)
...
* [simnalamburt/shellder](https://github.com/simnalamburt/shellder) - My own shell theme, crafted with :heart:
...
* [raphaelcohn/bish-bosh](https://github.com/raphaelcohn/bish-bosh) - MQTT shell script client, for bash, dash, BusyBox ash and others
...
* [olehkuchuk/dev-setup](https://github.com/olehkuchuk/dev-setup) - Shell script that automate installing dev tools for Linux box.
...
* [lwindolf/polscan](https://github.com/lwindolf/polscan) - Very simple bash script to run policy check shell snippets on Debian servers via SSH
...
* [tuminoid/gitlabci-installer](https://github.com/tuminoid/gitlabci-installer) - Easy shell script for installing Gitlab CI and Gitlab CI Runner, with Vagrant or on metal.
...
* [alexwasserman/GeekWeather2](https://github.com/alexwasserman/GeekWeather2) - Shell script to generate weather information using ForeCast.io API
* [MattiSG/DotFiles](https://github.com/MattiSG/DotFiles) - Aliases, functions and shell utilities.
* [Lukx/vagrant-lamp](https://github.com/Lukx/vagrant-lamp) - Readable, Transparent Shell-Provisioning for a LAMP-Environment with MariaDB
...
* [hashbang/shell-server](https://github.com/hashbang/shell-server) - The configuration files for the public hashbang.sh shell server.  Edit our server!
...
* [dalenys/svn2git](https://github.com/dalenys/svn2git) - :hash: Shell script to migrate from svn to git with history.
...
* [oldratlee/useful-shells](https://github.com/oldratlee/useful-shells) - 已废弃！迁移到https://github.com/oldratlee/useful-scripts
...
* [cmilfont/scripts-shell](https://github.com/cmilfont/scripts-shell) - Scripts uteis
...
* [charles-l/shmark](https://github.com/charles-l/shmark) - A minimal POSIX shell compliment bookmarking system [CURRENT STATE: working]
...
* [Earnestly/taverner](https://github.com/Earnestly/taverner) - A simple frontend for games (or anything) using dmenu and a bunch of shell scripts, totally the UNIX® Way!
...
* [oxnz/shell-utils](https://github.com/oxnz/shell-utils) - bash,zsh,sh utils functions and aliases, as well as some tools and maybe contain the dot-files in the future
...
* [josh-pope/Shell-Scripts](https://github.com/josh-pope/Shell-Scripts) - Scripts I use to automate some common tasks around MacOS
...
* [hackreactor/dotfiles](https://github.com/hackreactor/dotfiles) - Sane dotfiles for Hack Reactor's workstations. Because the default shell environment is a hostile place.
...
* [springlie/cecho](https://github.com/springlie/cecho) - Self-adapting colorful echo wrapper for shell.
...
* [cybernova/DNSaxfr](https://github.com/cybernova/DNSaxfr) - Shell script for testing DNS AXFR vulnerability
...
* [RigsOfRods/ror-linux-buildscripts](https://github.com/RigsOfRods/ror-linux-buildscripts) - Shell scripts to build Rigs of Rods git on apt based systems
...
* [mdoege/AmigaShell](https://github.com/mdoege/AmigaShell) - Makes the Linux virtual console look like the Commodore AmigaOS shell (formerly hosted at http://gnu.ethz.ch/linuks.mine.nu/amiga/ )
...
* [joshuar/bash-shell-config](https://github.com/joshuar/bash-shell-config) - A bash shell config.
...
* [dalenys/redmine-upgrade](https://github.com/dalenys/redmine-upgrade) - :hash: Shell script to upgrade from one version to another.
...
* [0mp/goat](https://github.com/0mp/goat) - A hacky shortcut manager for your shell.
...
* [steshaw/shelly](https://github.com/steshaw/shelly) - Shell tools and dotfiles
* [ssh0/dot](https://github.com/ssh0/dot) - dotfiles management framework with shell :shell:
...
* [rduplain/poorman](https://github.com/rduplain/poorman) - A shell port of foreman process management using Procfile and .env.
...
* [kintoandar/shell_scripts](https://github.com/kintoandar/shell_scripts) - Several shell scripts organized by function
...
* [jfcherng/Sublime-ShellScriptImproved](https://github.com/jfcherng/Sublime-ShellScriptImproved) - A better ShellScript (Bash) syntax highlight for Sublime Text >= 3092
...
* [DennyZhang/server-check](https://github.com/DennyZhang/server-check) - Provide a bunch of shell scripts and a simple web server to check health's of server
* [DennyZhang/check_proc_mem](https://github.com/DennyZhang/check_proc_mem) - Shell script to check proc memory, with output of nagios format
...
* [drKraken/interactive-shell](https://github.com/drKraken/interactive-shell) - bash script for learning basics of UNIX terminal.
...
* [drKraken/dev-setup](https://github.com/drKraken/dev-setup) - Shell script that automate installing dev tools for Linux box.
* [eriksencosta/vagrant-shell-scripts](https://github.com/eriksencosta/vagrant-shell-scripts) - Basic Shell scripts to provisioning Vagrant VMs. Mostly PHP based environments.
...
* [dalenys/svn-to-git](https://github.com/dalenys/svn-to-git) - :hash: Shell script to migrate from svn to git with history.
...
* [gloriajw/bash_crash](https://github.com/gloriajw/bash_crash) - bash shell class materials
* [xor-gate/foo-app](https://github.com/xor-gate/foo-app) - Proof-of-concept Mac OSX .app to execute a shell script
...
* [sotayamashita/electron-docs](https://github.com/sotayamashita/electron-docs) - :page_facing_up: Documentation for Electron (formerly atom-shell)
...
* [owatan/jel](https://github.com/owatan/jel) - AOJ shell client
...
* [dsh-project/dsh](https://github.com/dsh-project/dsh) - Distributed Shell / Dancer's shell
...
* [WilliamHackmore/linuxgems](https://github.com/WilliamHackmore/linuxgems) - A succinct cheat sheet for newbie linux coders and system administrators, documenting some of the more obscure and useful gems of linux lore. Intended to be viewed in emacs org-mode, or VimOrganizer, though any text editor will suffice.
...
* [oh-my-fish/oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) - Framework for managing your fish shell configuration inspired by Oh My ZSH.
...
* [resmo/git-ftp](https://github.com/resmo/git-ftp) - Deprected: Project moved to https://github.com/git-ftp/git-ftp
...
* [yascentur/Ricty](https://github.com/yascentur/Ricty) - Ricty --- fonts for programming
...
* [CISOfy/lynis](https://github.com/CISOfy/lynis) - Lynis - Security auditing and hardening tool for Unix/Linux based systems
...
* [zx2c4/password-store](https://github.com/zx2c4/password-store) - Simple password manager using gpg and ordinary unix directories. || Master source: http://git.zx2c4.com/password-store/ || Mailing list for contributions: http://lists.zx2c4.com/listinfo.cgi/password-store-zx2c4.com || Do not send pull requests. Send to list only.
...
* [n00ge/sublime-text-haml-sass](https://github.com/n00ge/sublime-text-haml-sass) - Haml & Sass language definitions and snippets for Sublime Text 2
...
* [alrra/dotfiles](https://github.com/alrra/dotfiles) - :wrench: OS X / Ubuntu dotfiles
...
* [rmarquis/pacaur](https://github.com/rmarquis/pacaur) - A fast workflow AUR helper using cower as backend
...
* [kelseyhightower/kubernetes-coreos](https://github.com/kelseyhightower/kubernetes-coreos) - Running Kubernetes on CoreOS
...
* [tejr/dotfiles](https://github.com/tejr/dotfiles) - Personal configuration files and a few trivial scripts
* [niieani/bash-oo-framework](https://github.com/niieani/bash-oo-framework) - Bash Infinity Framework is a modern boilerplate for bash.
...
* [DingSoung/hosts](https://github.com/DingSoung/hosts) - google facebook twitter youtube hosts for china
