...
* [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) - V2Ray+Websocket +TLS+Nginx+CDN+伪装博客+优选Cloudflare IP 一键脚本
...
* [xwmx/nb](https://github.com/xwmx/nb) - CLI plain-text note-taking, bookmarking, and archiving with encryption, advanced search, Git-backed versioning and syncing, Pandoc-backed conversion, and more in one portable script.
